...
/* Professional outline icon set (24px, stroke-based). No emojis. */

function Svg({ children, className = 'w-5 h-5', strokeWidth = 1.8 }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth={strokeWidth} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      {children}
    </svg>
  );
}
...
export function IconCash({ className }) {
  return (
    <Svg className={className}>
